import { TableOrderManagement } from '@/app/(admin)/admin/(orders)/table-order/[toid]/TableOrderManagement'
...
export default async function Page({ params: { toid } }: { params: { toid: string } }) {
   ...
   return (
      <>
         {/*@ts-ignore*/}
         <DashboardShell
            title={`Order ${tableOrder?.order_number}`}
         >
            
            <div className="space-y-4">
               <TableOrderManagement id={toid} />
