...
export const CreateTable = gql`
  mutation CreateTable($no_of_chairs: Int!, $qr_codes: jsonb, $restaurant_id: uuid!, $name: String!) {
    insert_tables_one(object: {no_of_chairs: $no_of_chairs, qr_codes: $qr_codes, restaurant_id: $restaurant_id, name: $name}) {
      id
    }
  }
`
...
export const UpdateTable = gql`
  mutation UpdateTable($id: uuid!, $no_of_chairs: Int!, $name: String!, $qr_codes: jsonb) {
    update_tables_by_pk(pk_columns: {id: $id}, _set: {no_of_chairs: $no_of_chairs, name: $name, qr_codes: $qr_codes}) {
      id
    }
  }
`
